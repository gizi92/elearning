...
/*
 * It makes sense to use the Builder pattern only
 * when your products are quite complex
 * and require extensive configuration.
 *
 * Unlike other creational patterns,
 * differenct concrete builders can produce
 * unrelated products. In other words,
 * results of various builders may not always
...
class ConcreteBuilder1 : public Builder {
	...
	/*
	 * A fresh builder instance should contains a blank product object,
	...
	public:
		...
		void Reset() {
			this->product = std::make_shared<Product1>();
		}
