...
/*
 * The basse Decorator class follows the same interface as other
 * components. The primary purpose of this class is to define
 * the wrapping interface for the concrete decorators.
 * The default implementation of the wrapping code might
 * include a field for storing a wrapped component
 ...
 * the call to the wrappped object.
 */
...
int main(void){
     ...
     *
     * Note how the decorators can wrap not only simple components but other decorators as well.
     */
